 ...
 <script type="text/javascript">
	...
	function construirTablaRequerimiento(dataGrilla) {
		...
		$('#tblRequerimientos').DataTable({
			...
			columns : [
			    //PAS20201U210500029 - HHC INICIO ,se comentara porque el resultado sera por expediente
...
// 							{
// 								"class" : "cimg glyphicon glyphicon-pencil",
// 								onClick : "regEscritoElec("+data+")"
// 							}
// 						).wrap('<div></div>').parent().html();
// 					},
// 				 },
				 {data : "codEstado", sClass: 'hidden alinearCentrado'},
// 				 {data : "codEstadoExp", sClass: 'hidden alinearCentrado'},
// 				 {data : "codTipoExp", sClass: 'hidden alinearCentrado'},
...
// 				 {data : "codTipDoc", sClass: 'hidden alinearCentrado'},
				 {data : "codDependencia", sClass: 'hidden alinearCentrado'}
			],
			data: dataGrilla,
            autoWidth			:   false,
			ordering			:	true,
...
// 				url : '${pageContext.request.contextPath}/cargarDocumentoIt.htm?action=cargarListadoRequerimientosPendientes',
				url : '${pageContext.request.contextPath}/cargarDocumentoIt.htm?action=cargarListadoExpedientesPendientes',
			    //PAS20201U210500029 - HHC fin
				type : 'POST', //eaguilar 12 JUL
				async : true,
				dataType : "json",
...
<!--  				<h3 class="panel-title" align="center">INGRESO VIRTUAL DE DOCUMENTOS</h3> --> <!--PAS20191U210500291 - JMC 04/12/2019-->
					<h3 class="panel-title" align="center">PRESENTACI&Oacute;N DE ESCRITOS ELECTR&Oacute;NICOS</h3>
					<form id="frmPrincipal" class="form-horizontal" role="form"></form>
				</div>
			</div>	
			<div class="panel panel-primary">
				...
				<form class="form-horizontal" role="form" name="frmFiltroBusquedaAvanzada" id="frmFiltroBusquedaAvanzada" method="post">
					<fieldset class="scheduler-border" style="margin : 15px 15px !important">
						...
						<div class="form-group">
							<div class="col-md-1"><Strong>Fecha de Expediente: Desde:</Strong></div>
							<!--[PAS20191U210500291]: JMC 04/12/2019 - INI-->
<!-- 							<div class="col-md-3"> -->
...
<!-- 							<div class="col-md-1"><Strong>Desde:</Strong></div> -->
							<!--[PAS20191U210500291]: JMC 04/12/2019 - FIN-->
							<div class="col-md-3">
			...
			<div class="panel panel-primary">
				<div class="panel-heading align="center">
<!-- 				<h3 class="panel-title" align="center">REQUERIMIENTOS PENDIENTES DEL CONTRIBUYENTE</h3> --> <!--PAS20191U210500291 - JMC 04/12/2019-->
<!-- 					<h3 class="panel-title" align="center">LISTA DE REQUERIMIENTOS</h3> -->
					<h3 class="panel-title" align="center">LISTA DE EXPEDIENTES</h3><!--HHC-->
				</div>
			</div>
			<div class="panel panel-primary">
				<fieldset class="scheduler-border" style="margin : 15px 15px !important">
<!-- 					<legend class="scheduler-border"> Listado de Requerimientos </legend> -->
						<legend class="scheduler-border"> Listado de Expedientes </legend><!--HHC-->
					<div class="form-group">
						<div class="col-md-12">	
...
<!-- 							<div class="border-line panel-scroll"> -->
							...
							<table id="tblRequerimientos" class="table display" style="width: 100%;">
								<thead>
									<tr>
										<!--PAS20201U210500029 - HHC INICIO se elimino campos-->
...
<!-- 										<th width="10%" class="text-center">Escritos</th> -->
									</tr>
								</thead>
							</table>
							</div>
				...
				<fieldset style="margin : 15px 15px !important">
					<div class="form-group">
						<div class="col-md-7" align="right" id="dvSecBotones01">	
							<!-- <input type="button" class="btn btn-primary"  id="btnConsulta" intermediateChanges="false" data-dismiss="modal" value="Subir Documentos" id="btnCargarr" onClick="cargarDatosBusquedaSession()"></input> -->
						...
						<div class="col-md-2" id="dvSecBotones01">
						</div>	
						<!--[PAS20191U210500291]: JMC 04/12/2019 - INI-->
<!-- 						<div class="col-md-3"> -->
<!-- 							<div class=" form-group"> -->
...
<!-- 										<strong>Seguimiento plazo:</strong> -->
<!-- 									</div>		 -->
<!-- 								</div> -->
<!-- 								<div class="form-group"> -->
<!-- 									<div class="col-md-4" > -->
<!-- 										<div class="col-md curso" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;En&nbsp;curso</div> -->
<!-- 									</div>	 -->
<!-- 									<div class="col-md-4"  > -->
<!-- 										<div class="col-md alerta" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alerta</div> -->
<!-- 									</div>	 -->
<!-- 									<div class="col-md-4" > -->
<!-- 										<div class="col-md vencido" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vencido</div>	 -->
<!-- 									</div>	 -->
<!-- 								</div>	 -->
<!-- 							</div>	 -->
<!-- 						</div>	 -->
