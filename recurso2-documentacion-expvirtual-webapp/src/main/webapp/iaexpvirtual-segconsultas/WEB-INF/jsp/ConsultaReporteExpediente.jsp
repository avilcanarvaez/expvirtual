...
<title>CONSULTA Y REPORTES DE EXPEDIENTES</title>
...
<div id="container" class="container" style="width: 95%">
			<div class="row">
				<div class="panel panel-primary">
					<div class="panel-heading align="center">
						<h3 class="panel-title" align="center">CONSULTA Y REPORTES DE EXPEDIENTES</h3>
									...
									<table id="tblExpedientes" class="table display" cellspacing="0" style="width: 100%;">
										<thead>
											<tr>
												...
												<th width="8%" class="text-center">N&deg; de Expediente Acumulador</th>
												<!-- Inicio [jquispe 27/05/2016]  Modificado para agregar la columna Indicador de Acumulacion. -->
												<th width="4%" class="text-center">Indicador de Acumulaci&oacute;n</th>
												...
												<!-- Fin [jquispe 27/05/2016] -->
												<th width="7%" class="text-center">Estado Cierre</th>
												<th width="5%" class="text-center">Fecha de Registro del Expediente</th>
												<th width="5%" class="text-center">Fecha del Documento Origen</th>
												<!--Inicio JEFFIO  13/03/2017-->
												<th width="8%" class="text-center">Fecha de Notificaci&oacute;n</th>
												<th width="8%" class="text-center">Forma de Notificaci&oacute;n</th>
	...
	<!-- 		MODAL DOCUMENTOS Detalle de Documentos -->
										...
										<legend class="scheduler-border">Datos del Expediente</legend>
											<div class="panel-body">
												...
												<div class="row content-box">
													...
													<div id="txtCampo2" class="col-md-3">
														<input id="numExpeVirtualDocumentoModal" name="numeroExpeVirtual" type="text" class="form-control" disabled="disabled"/>
													</div>
													<div class="col-md-1">
												...
												<div class="border-line panel-scroll">		
													<table id="tableDocumentoModal" class="table display" cellspacing="0" style="width: 100%;">
														<thead >
															<tr>
														    	<th width="3%">N&deg;</th>
														    	<!-- Inicio [jquispe 31/05/2016]  Modificado para eliminar la columna nombre del archivo. -->
																<th width="20%">Tipo de Documento</th>
																<!-- Fin [jquispe 31/05/2016] -->
																<th width="10%">N&uacute;mero de Documento</th>																
																<!-- Inicio [jquispe 31/05/2016]  Modificado para eliminar la columna nombre del archivo. -->
																<!--  <th width="24%">Nombre del Archivo</th> -->
																<!-- Fin [jquispe 31/05/2016] -->
																<!-- Inicio [jquispe 27/05/2016]  Modificado para agregar la columna Fecha emision de documento. -->
																...
																<!--fin JEFFIO  13/03/2017-->
																<th width="5%">N&deg; de Expediente Origen</th>																	
																<!-- Inicio [jquispe 27/05/2016]  Modificado para agregar la columna Fecha emision de documento. -->
		...
		<!-- MODAL DOCUMENTOS Detalle de Documentos TIPO 430, 431 -->
		<div id="modalDocumentosFis" class="modal fade" role="dialog" style="width: 100%">
			<div class="modal-dialog" style="width: 1000px !important;">
				<div class="panel panel-info">
					<div class="panel-heading">
						<div>
						<div class="panel-heading">
							...
							<div id="dlgTitleModalDocumentosFis"></div>
						</div>
							<div class="row">
									<div class="panel panel-primary">
										<fieldset class="scheduler-border" style="margin : 15px 15px !important">
										<legend class="scheduler-border">Datos del Expediente</legend>
											<div class="panel-body">
												<div class="row content-box">
													...
													<div id="txtCampoRuc" class="col-md-2">
														<input id="numRucDocumentoModalFis" name="numeroRuc" type="text" class="form-control" disabled="disabled"/>
													</div>
													<div id="txtCampoRazonSocial" class="col-md-8">
														<input id="razonSocialDocumentoModalFis" name="razonSocialRuc" type="text" class="form-control" disabled="disabled"/>
													</div>
												</div>
												<div class="row content-box">&nbsp;</div>
												<div class="row content-box">
												<!-- MODAL Detalle de Documentos LLRB 18/02 -->
													<div class="col-md-2">
														<label>N&deg; Expediente:</label>
													</div>
													<div id="txtCampo1" class="col-md-2">
														<input id="numExpeOrigenDocumentoModalFis" name="numeroExpeOrigen" type="text" class="form-control" disabled="disabled"/>
													</div>
													<!--<div class="col-md-2">
														<label>N&deg; Expediente Virtual:</label>
													</div>
													<div id="txtCampo2" class="col-md-3">
														<input id="numExpeVirtualDocumentoModalFis" name="numeroExpeVirtual" type="text" class="form-control" disabled="disabled"/>
													</div> -->
													<div class="col-md-1">
														<label>Estado expediente:</label>
													</div>
													<div id="txtCampo3" class="col-md-2">
														<input id="estExpedienteDocumentoModalFis" name="estadoExpediente" type="text" class="form-control" disabled="disabled"/>
													</div>												
												</div>	
												<div class="row content-box">&nbsp;</div>
												<div class="row content-box">												
													...
													<div id="txtCampo4" class="col-md-2">
														<input id="desProcesoDocumentoModalFis" name="descripcionProceso" type="text" class="form-control" disabled="disabled"/>
													</div>
													<div class="col-md-2">
														<label>Tipo de expediente:</label>
													</div>
													<div id="txtCampo5" class="col-md-3">
														<input id="desExpedienteDocumentoModalFis" name="descripcionExpediente" type="text" class="form-control" disabled="disabled"/>
													</div>
													<div class="col-md-1">
														<label>Origen:</label>
													</div>
													<div id="txtCampo6" class="col-md-2">
														<input id="desOrigenDocumentoModalFis" name="descripcionOrigen" type="text" class="form-control" disabled="disabled"/>
													</div>													
												</div>
												<div class="row content-box">&nbsp;</div>
												<div class="row content-box">
													...
													<div id="txtCampo7" class="col-md-2">
														<input id="fechaVirtualDocumentoModalFis" name="fechaExpedienteVirtual" type="text" class="form-control" disabled="disabled"/>
													</div>
													<div class="col-md-2">
														<label>Fecha de documento origen:</label>
													</div>
													<div id="txtCampo8" class="col-md-2">														
														<input id="fechaOrigenDocumentoModalFis" name="fechaOrigenExpediente" type="text" class="form-control" disabled="disabled"/>
													</div>
												</div>
												</div>
										</fieldset>
										...
										<fieldset class="scheduler-border" style="margin : 15px 15px !important">			
											<legend class="scheduler-border">Listado de Documentos </legend>
												...
												<div id="accionesFiscalizacion" class="tab-pane fade in active">
												<div class="border-line panel-scroll">		
													<table id="tableDocumentoModalFis" class="table display" cellspacing="0" style="width: 100%;">
														<thead >
															<tr>
														    	<th width="3%">N&deg;</th>
														    	<th width="19%">Tipo de Documento</th>
																<th width="9%">N&uacute;mero de Documento</th>																
																<th width="9%">Origen registro documento</th>
																<th width="4%">Visible al Contrib.</th>
																<th width="4%">Con Reserva Tributaria</th>
																<th width="22%">Responsable registro documento</th>
																<th width="5%">Fecha registro documento</th>
																<th width="5%">Fecha emisi&oacute;n documento</th>
																<th width="9%" >Fecha de Notificaci&oacute;n</th>
																<th width="9%" >Forma de Notificaci&oacute;n</th>
																<th width="5%">N&deg; de Expediente</th>																
																<th width="5%">Tip. Doc. Relacionado</th>
...
<!-- 																<th></th> -->
										...
										<div class="form-group">
											<div class="col-md-12" align="center" id="dvSecBotones01">	
												<button type="button" class="btn btn-primary" intermediateChanges="false" id ='exportarDocumentosFis' onclick="exportarDocumentosModalFis()">Exportar a Excel</button>
											</div>
										</div>	
									</div>	
										<form id="formDocumentoModalFis" class="form-horizontal" role="form">
											<input id="hiddenListaExpDocumentoModalFis" type="hidden" name="hiddenListaExpDocumentoModalFis"/>		
											<input id="hiddenNumRucDocumentoModalFis" type="hidden" name="hiddenNumRucDocumentoModalFis"/>
											<input id="hiddenRazonSocialDocumentoModalFis" type="hidden" name="hiddenRazonSocialDocumentoModalFis"/>
											<input id="hiddenNumExpOrigenDocumentoModalFis" type="hidden" name="hiddenNumExpOrigenDocumentoModalFis"/>
											<input id="hiddenNumExpVirtualDocumentoModalFis" type="hidden" name="hiddenNumExpVirtualDocumentoModalFis"/>
											<input id="hiddenEstExpedienteDocumentoModalFis" type="hidden" name="hiddenEstExpedienteDocumentoModalFis"/>
											<input id="hiddenTipoProcesoDocumentoModalFis" type="hidden" name="hiddenTipoProcesoDocumentoModalFis"/>
											<input id="hiddenTipoExpedienteDocumentoModalFis" type="hidden" name="hiddenTipoExpedienteDocumentoModalFis"/>
											<input id="hiddenDescOrigenDocumentoModalFis" type="hidden" name="hiddenDescOrigenDocumentoModalFis"/>
											<input id="hiddenFechaGeneracionDocumentoModalFis" type="hidden" name="hiddenFechaGeneracionDocumentoModalFis"/>
											<input id="hiddenFechaOrigenDocumentoModalFis" type="hidden" name="hiddenFechaOrigenDocumentoModalFis"/>
											<input id="hiddenfechaNotificacionModalFis" type="hidden" name="hiddenfechaNotificacionModalFis"/>
											<input id="hiddenforhaNotificacionModalFis" type="hidden" name="hiddenforhaNotificacionModalFis"/>	
											<!-- INICIO LROMERO -->	
	...
	<!-- 	Inicio LLRB 16/01/2020	MODAL LISTA COPIAS  -->
								...
								<div class="row">
									<div class="panel panel-primary">
										<fieldset class="scheduler-border" style="margin : 15px 15px !important">
											...
											<!-- INICIO[LLRB 16012020] -->
											<div class="form-group" id="trazabilidadFisca">	
											<div class="panel-body">
												<div class="row content-box">
													<div class="col-md-3">
														<label>RUC: </label>
	...
	$(function () {
		...
		// Inicio [jquispe 02/06/2016] Modificado para la busqueda por RUC.
		...
		//Fin jquispe 16/06/2016
		 ...
		 // Inicio [jquispe 02/06/2016] Agregado para la busqueda por RUC.
								...
								if(numRuc!=""){
									...
									if(!valruc(numRuc)){
										...
										if(razonSocial==""){
										   ...
										   // Inicio [jquispe 27/05/2016] No permite la validacion de algunos campos de la Consulta Avanzada.
		...
		//Inicio [jquispe 13/07/2016] Comentado para el envio POST.
		//$.ajaxSetup({ scriptCharset: "UTF-8" , contentType: "application/json; charset=utf-8"});
		//Fin [jquispe 13/07/2016]
	...
	//Inicio [jquispe 02/06/2016] Permite la validacion de la busqueda por fecha.
	...
	function construirTablaExpediente(dataGrilla) {
    	var table = $('#tblExpedientes').DataTable({
			...
			paging				:	true,
			pagingType			:   "full_numbers",
			iDisplayLength		:	5, //eaguilar 04 JUL paginado a 15//jquispe 05/07/2016 actualizado a 5
			//responsive			:	true,
			bLengthChange		: 	false,
			...
			columns: [	
						...
						// Inicio [jquispe 27/05/2016] Descripcion del Indicador de Acumulacion.
						...
						{data :	"numExpedienteVirtual","defaultContent":"", render : function(data,type, row){			
								...
								// Inicio [jquispe 30/05/2016] Opcion para generar el archivo PDF con indice del expediente electronico.
								var link3 = '<a onclick="obtenerPdf('+data+','+row.numExpedienteOrigen+')" >Generar &Iacute;ndice</a>';
								// Fin [jquispe 30/05/2016]
								//INICIO LLRB 16012020
	...
	function verRepImpresa(idxFila){
		...
		if($("#numRucDocumentoModal").val()!=""){
			...
			dataEnvio.docData = JSON.stringify($('#tableDocumentoModalFis').DataTable().row(idxFila).data());
			...
			success : function(response) {				
				...
				if (lstDocExp.length > 0) {
					if(datosExpedientes.codTipoExpediente== '430' ||datosExpedientes.codTipoExpediente== '431' ){
						...
						$('#tableDocumentoModalFis').dataTable().fnClearTable();
						$('#tableDocumentoModalFis').dataTable().fnAddData(lstDocExp); //carga registros en grilla					
        ...
        //PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
				...
				//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA
  				if (lstObsExp.length > 0) {
  					...
  					$('#tableObservaciones').dataTable().fnClearTable();
  					$('#tableObservaciones').dataTable().fnDraw(); 		
   ...
   //Inicio [jquispe 30/05/2016] Funcion creada para generar el archivo pdf con indice de expediente electronico.
	function obtenerPdf(numExpedienteVirtual,numExpedienteOrigen){		 
        //PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA 
		consultarResponsables(numExpedienteVirtual,numExpedienteOrigen);
 		//var dataEnvio = new Object();		
	...
	function validarContribuyente(){
		...
		$.ajax({
			...
			url : '${pageContext.request.contextPath}/conRepControl.htm?action=validarContribuyente',
			type : 'POST',
			async : false,
			dataType : "json",
			data : '&numRuc='+numRuc,
	...
	function exportarExcel(){
		...
		if(dataExp.length > 0){
			...
			var listaCadena = JSON.stringify(dataExp);
		    var formURL = 'conRepControl.htm?action=exportarExcelExpedientes';
			...
			var formURL = 'conRepControl.htm?action=exportarExcelExpedientesFisca';
		    document.forms.formPrincipal.action = formURL;
			document.forms.formPrincipal.method = "POST";
			$('#campoHiddenExp').val('');
			$('#campoHiddenExp').val(listaCadena);
	...
	function consultarExpedientes(){
		...
		// Inicio [jquispe 05/07/2016] Agregado para obtener el numero de expediente cuando esta deshabilitado.
		...
		if(tipoBusqueda !=""){
			if ($txtNumeroExpediente.val()==""){			
				 mostrarDlgInfo("Consulta Expediente", "Ingrese Número de Expediente");
		       }
		}
		...
		$.ajax({
			...
			url : '${pageContext.request.contextPath}/conRepControl.htm?action=obtenerExpedientesVirtuales',
			type : 'POST',
			async : true,
			dataType : "json",
			data : urlFiltroBusqEspecifica +'&'+$('#frmFiltroBusquedaAvanzada').serialize(),//[jquispe 05/07/2016] Agregado para obtener el numero de expediente cuando esta deshabilitado.
			//contentType : "application/json",
			mimeType : "application/json",
			//timeout : 5000,
			success : function(response) {
		...
		$.ajax({
			...
			success : function(response) {
				...
				if((datosExpedientes.codTipoExpediente == 430 || datosExpedientes.codTipoExpediente == 431) ) {
					...
					$('#numExpeVirtualExpedienteModal_f').attr("value", datosExpedientes.numExpedienteVirtual);					
					...
					// Inicio [jquispe 27/05/2016] La fecha del expediente debe ser de origen.
	...
	function construirTablaDocumentos(data){
		...
		var tableDM = $('#tableDocumentoModalFis').DataTable( {
					"language": {
						"url"		:	"../a/js/libs/bootstrap/3.3.2/plugins/datatables-1.10.7/plug-ins/1.10.7/i18n/Spanish.json"
					},
					oLanguage : {
					...
					columns : [
						...
						// Inicio [jquispe 27/05/2016] Numero de Acumulador.
			...
			//Inicio LLRB
					...
					fnDrawCallback		:	function(oSettings) {
						...
						if (oSettings.fnRecordsTotal() == 0) {
							$('#tableDocumentoModalFis_paginate').addClass('hiddenDiv'); //el footer de paginacion siempre tiene como ID "miTablaID_paginate"
																				//no se oculta automaticamente
																	//cuando hay 0 registros, por eso se oculta anadiendo el class .hiddenDiv
				        }
						else {
							$('#tableDocumentoModalFis_paginate').removeClass('hiddenDiv');
		...
		//Inicio LLRB 
		var tableDC = $('#tableDocumentoModal').DataTable( {
			"language": {
				"url"		:	"../a/js/libs/bootstrap/3.3.2/plugins/datatables-1.10.7/plug-ins/1.10.7/i18n/Spanish.json"
			},
			oLanguage : {
			...
			columns : [
				...
				{data :	"numDoc" ,"defaultContent":""},
				{data :	"desOrigen" ,"defaultContent":""},
				{data :	"nroRequerim","defaultContent":"" },
				{data :	"nomPersonaCargo","defaultContent":""},		
				{data :	"fecCargVista","defaultContent":"" },	
				{data :	"fechaVista","defaultContent":"" },
				{data : "fecNotifVista", "defaultContent":"" },
		...
		$.ajax({
			...
			success : function(response) {	
				...
				//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA				
                    if (lstDocExp.length > 0) {
                        //PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
						if(tipoExpediente.tipoExp == '430' || tipoExpediente.tipoExp == '431' ){
							
							$('#tableDocumentoModalFis').dataTable().fnClearTable();
							$('#tableDocumentoModalFis').dataTable().fnAddData(lstDocExp); //carga registros en grilla	
							$('#exportarDocumentosFis').attr('disabled', false);
						...
						if(tipoExpediente.tipoExp == '430' || tipoExpediente.tipoExp == '431' ){
							...
							$('#tableDocumentoModalFis').dataTable().fnClearTable();
							$('#tableDocumentoModalFis').dataTable().fnAddData(lstDocExp); //carga registros en grilla	
							$('#exportarDocumentosFis').attr('disabled', true);
				    ...
				    if(tipoExpediente.tipoExp == '430' || tipoExpediente.tipoExp == '431' ){
				    	...
				    	$('#numRucDocumentoModalFis').attr("value", datosExpedientes.numRuc);
						$('#razonSocialDocumentoModalFis').attr("value", razonSocial);
						$('#numExpeOrigenDocumentoModalFis').attr("value", datosExpedientes.numExpedienteOrigen);
						$('#numExpeVirtualDocumentoModalFis').attr("value", datosExpedientes.numExpedienteVirtual);
						$('#estExpedienteDocumentoModalFis').attr("value", datosExpedientes.desEstado);
						$('#desProcesoDocumentoModalFis').attr("value", datosExpedientes.desProceso);
						$('#desExpedienteDocumentoModalFis').attr("value", datosExpedientes.desTipoExpediente);
						$('#desOrigenDocumentoModalFis').attr("value", datosExpedientes.desOrigen);
						$('#fechaOrigenDocumentoModalFis').attr("value", fechaOrigenDoc);
						$('#fechaVirtualDocumentoModalFis').attr("value", fechaRegistro);
				    	var titulo = "Detalle de Documentos - N&deg; Expediente Virtual " + datosExpedientes.numExpedienteVirtual;
	                	mostrarModalFis(titulo);
				...
				setTimeout(
						function(){
								...
								if(tipoExpediente.tipoExp == '430' || tipoExpediente.tipoExp == '431' ){
									...
									$("#tableDocumentoModalFis_wrapper").css("min-width", $('#tableDocumentoModalFis').width());
									$('#tableDocumentoModalFis_paginate').addClass('div100');
  ...
  //PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
	function mostrarModalFis(titulo){
		$('#dlgTitleModalDocumentosFis').html(titulo);
		$('#modalDocumentosFis').modal('show');
	}
   //PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA
	function mostrarModal(titulo){
		$('#dlgTitleModalDocumentos').html(titulo);
	...
	//PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
	function consultarResponsables(numExpedienteVirtual,numExpedienteOrigen){

		var dataEnvio = new Object();
		
		$.ajax({
			url : '${pageContext.request.contextPath}/conRepControl.htm?action=consultarRespExpVirtual',
			type : 'POST',
			async : true,
			dataType : "json",
			data : "&numExpedienteVirtual="+numExpedienteVirtual,
	...
	//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA
	//PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
	function exportarDocumentosModalFis(){		
		
		var dataExp = $('#tableDocumentoModalFis').dataTable().fnGetData();
		
		if(dataExp.length > 0){
		
			var listaCadena = JSON.stringify(dataExp);
			var formURL = 'conRepControl.htm?action=exportarExcelExpDocFis';
			document.forms.formDocumentoModalFis.action = formURL;
			document.forms.formDocumentoModalFis.method = "POST";
			/*Obtener Paramtros Inicio*/
			var numRuc = $('#numRucDocumentoModalFis').val();
			var razonSocial = $('#razonSocialDocumentoModalFis').val();
			var numExpeOrigen = $('#numExpeOrigenDocumentoModalFis').val();
			var numExpeVirtual = $('#numExpeVirtualDocumentoModalFis').val();
			var estExpediente = $('#estExpedienteDocumentoModalFis').val();
			var desProceso = $('#desProcesoDocumentoModalFis').val();
			var desExpediente = $('#desExpedienteDocumentoModalFis').val();
			var desOrigen = $('#desOrigenDocumentoModalFis').val();
			var fechaOrigen = $('#fechaOrigenDocumentoModalFis').val();
			var fechaVirtual = $('#fechaVirtualDocumentoModalFis').val();
			var fechaNotificacion=$('#fechaNotifiDocumentoModalFis').val();
			var formaNotificacion=$('#formaNotifiDocumentoModalFis').val();
			/*Obtener Paramtros fin*/
			/*limpiar campos hdn Inicio*/
			$('#hiddenListaExpDocumentoModalFis').val('');
			$('#hiddenNumRucDocumentoModalFis').val('');
			$('#hiddenRazonSocialDocumentoModalFis').val('');
			$('#hiddenNumExpOrigenDocumentoModalFis').val('');
			$('#hiddenNumExpVirtualDocumentoModalFis').val('');
			$('#hiddenEstExpedienteDocumentoModalFis').val('');
			$('#hiddenTipoProcesoDocumentoModalFis').val('');
			$('#hiddenTipoExpedienteDocumentoModalFis').val('');
			$('#hiddenDescOrigenDocumentoModalFis').val('');
			$('#hiddenFechaGeneracionDocumentoModalFis').val('');
			$('#hiddenFechaOrigenDocumentoModalFis').val('');
			$('#hiddenfechaNotificacionModalFis').val('');
			$('#hiddenforhaNotificacionModalFis').val('');
			$('#hidden')
			/*limpiar campos hdn Inicio*/
			/*setear campos hdn Inicio*/
			$('#hiddenListaExpDocumentoModalFis').val(listaCadena);
			$('#hiddenNumRucDocumentoModalFis').val(numRuc);
			$('#hiddenRazonSocialDocumentoModalFis').val(razonSocial);
			$('#hiddenNumExpOrigenDocumentoModalFis').val(numExpeOrigen);
			$('#hiddenNumExpVirtualDocumentoModalFis').val(numExpeVirtual);
			$('#hiddenEstExpedienteDocumentoModalFis').val(estExpediente);
			$('#hiddenTipoProcesoDocumentoModalFis').val(desProceso);
			$('#hiddenTipoExpedienteDocumentoModalFis').val(desExpediente);
			$('#hiddenDescOrigenDocumentoModalFis').val(desOrigen);
			$('#hiddenFechaGeneracionDocumentoModalFis').val(fechaVirtual);
			$('#hiddenFechaOrigenDocumentoModalFis').val(fechaOrigen);
			$('#hiddenfechaNotificacionModalFis').val(fechaNotificacion);
			$('#hiddenforhaNotificacionModalFis').val(formaNotificacion);
			
			/*setear campos hdn fin*/
			$('html').block({message: '<h1>Procesando</h1>'});
			document.forms.formDocumentoModalFis.submit();
			$('html').unblock();
		}
	}
	//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA
	 ...
	 function validarSolicitud(idxFila){		
		 var dataExp = $('#tblExpedientes').dataTable().fnGetData();
			if(dataExp.length > 0){
				...
				var dataEnvio = new Object();		 	
				dataEnvio.docData = JSON.stringify($('#tblExpedientesFisca').DataTable().row(idxFila).data());
			}
			...
			$.ajax({
				...
				success : function(response) {
					...
					var excepciones = response.excepciones;	
		...
		$.ajax({
			...
			success : function(response) {	
				...
				if (excepciones.excepcion02 != null){
					...
					mostrarDlgInfoExp(titulos.tituloDefecto, excepciones.excepcion02);
				...
				//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA				
                 ...
                 //PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
				    if(tipoExpediente.tipoExp == '430' || tipoExpediente.tipoExp == '431' ){
						...
						$('#fechaVirtualDocumentoModalFis').attr("value", fechaRegistro);
				    	var titulo = "Detalle de Documentos - N&deg; Expediente Virtual " + datosExpedientes.numExpedienteVirtual;
	                	mostrarModalFisVinculados(titulo);
...
//PAS20191U210500144 Inicio 400104 RF03 PSALDARRIAGA
	function mostrarModalFisVinculados(titulo){
		$('#dlgTitleModalDocumentosFis').html(titulo);
		$('#modalDocumentosFis').modal('show');
	}
//PAS20191U210500144 Fin 400104 RF03 PSALDARRIAGA
