...
<html lang="es">
	...
	<head>
		...
		<title>TRAZABILIDAD DE LOS ESTADOS Y  ETAPAS DE LOS EXPEDIENTES OR&Iacute;GENES</title>
	...
	<body>
		...
		$(document).ready(function() {
			...
			$('#tableDocumento').dataTable().fnAddData(lstTrazExp);
