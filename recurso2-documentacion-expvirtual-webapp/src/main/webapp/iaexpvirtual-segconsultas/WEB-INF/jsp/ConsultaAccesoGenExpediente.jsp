...
<title>CONSULTA Y REPORTES DE EXPEDIENTES GENERAL</title>
			...
			<div class="row">
				<div class="panel panel-primary">
					<div class="panel-heading align="center">
						<h3 class="panel-title" align="center">CONSULTA Y REPORTES DE EXPEDIENTES GENERAL</h3>
   ...
   //Inicio [jquispe 30/05/2016] Funcion creada para generar el archivo pdf con indice de expediente electronico.
	...
	function consultarExpedientes(){
		...
		$.ajax({
			...
			url : '${pageContext.request.contextPath}/conRepControl.htm?action=obtenerAccesoTotalExpVirt',
			type : 'POST',
			async : true,
			dataType : "json",
