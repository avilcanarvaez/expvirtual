...
// 			console.log(objJSON);
			var url = "regReqControl.htm?action=descargarArchivo&codIdentificadorECM="+ codIdentificadorECM +"&nombreArchivo="+encodeURI(descripcionArchivo);
			window.open(url);
		});
	})   
    ...
    function construirTableDocumento(dataGrilla){
    	...
    	$('#tblDocumentos').DataTable({
			...
			columns : [
				...
				{data : "codIdentificadorECM", sClass: 'center alinearCentrado',"defaultContent":"",render:function(data,row,full){
	...
	function volverPagina(){
		...
		var url='${pageContext.request.contextPath}/regReqControl.htm?action=consultarDetalleExpedienteVirtualView&numExpedienteVirtual='+numExpVirtual;
	...
	function exportarExcelDocumentos(){
		...
		if(dataExp.length > 0){
		    ...
		    var formURL = 'regReqControl.htm?action=exportarExcelDocumentos';
			...
			<div class="row">
				...
				<div class="panel panel-primary">
					<form class="form-horizontal" role="form" name="frmDatosExpediente" id="frmDatosExpediente" method="post">
						...
						<fieldset class="scheduler-border" style="margin : 15px 15px !important">
							...
							<div class="form-group">
								...
								<div class="col-md-2"><Strong>N&uacute;mero de Requerimiento:</Strong></div>
								<div class="col-md-3">
									<input type="text" class="form-control tamanoMaximo" value='${numRequerimientoOrigen}' disabled></input>
								</div>
							</div>
							-->
							<div class="form-group">
						...
						<fieldset class="scheduler-border" style="margin : 15px 15px !important">
							...
							<div class="form-group">
								...
								<div class="col-md-3">																		
									<input type="text"  class="form-control tamanoMaximo" value='${t6620RequerimBean.fecRegistro}' disabled></input>
								</div>
					...
					<fieldset id="contentDocumentos" class="scheduler-border" style="margin : 15px 15px !important">
							<legend class="scheduler-border"> Documentos del Requerimiento</legend>
							<div class="form-group">
								<div class="col-md-12">	
								...
								<table id="tblDocumentos" class="table display table table-striped dataTable no-footer" cellspacing="0" style="width: 100%;">
										<thead>
											<tr>
												...
												<th width="20%" class="text-center">Estado de Envio del Doc.</th>
											</tr>
										</thead>
									</table>
									</div>
				...
				<fieldset  style="margin : 15px 15px !important">
							<div class="form-group">
								...
								<div class="col-md-2" align="center" id="dvSecBotones01">	
