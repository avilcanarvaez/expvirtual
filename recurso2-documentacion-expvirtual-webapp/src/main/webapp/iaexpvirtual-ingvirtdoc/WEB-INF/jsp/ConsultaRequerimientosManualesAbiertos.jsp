					...
					<form class="form-horizontal" role="form" name="frmDatosExpediente" id="frmDatosExpediente" method="post">
						...
						<fieldset class="scheduler-border" style="margin : 15px 15px !important">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input name="txtFechaRegExpediente" id="txtFechaNotif" type="text"  class="form-control tamanoMaximo" value='${fechaRegExpediente}' disabled></input>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-2"><Strong>Forma de Notificaci&oacute;n:</Strong></div>
								<div class="col-md-3">
									<input name="txtFechaDocOrigen" id="txtFormaNotif" type="text" class="form-control tamanoMaximo" value='${fechaDocOrigen}' disabled></input>
								</div>
