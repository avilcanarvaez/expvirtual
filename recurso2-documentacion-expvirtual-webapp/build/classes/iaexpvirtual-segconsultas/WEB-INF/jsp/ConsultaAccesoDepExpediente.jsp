...
<title>CONSULTA Y REPORTES DE EXPEDIENTES POR DEPENDENCIA</title>
			...
			<div class="row">
				<div class="panel panel-primary">
					<div class="panel-heading align="center">
						<h3 class="panel-title" align="center">CONSULTA Y REPORTES DE EXPEDIENTES POR DEPENDENCIA</h3>
...
//Fin [jquispe 02/06/2016]
	...
	function resetearFormularioConEsp(event){
		...
		if(current.id != "selDependencia"){
			if($("#selCodigoProceso").val() == "" && current.id != "txtRuc") $('#frmFiltroBusquedaEspecifica').bootstrapValidator('revalidateField', 'codTipexp');
		}
